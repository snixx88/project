...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2025 at 07:29 PM
...
(2, 'snixx1@email.com', '123456'),
(3, 'snixx12@gmail.com', '1234');
...
(1, 'i', 'ix', 'BMW ix', 200, 516, 5409, '../img/ix.webp', 'qq', 'Electric', '', '123'),
...
(13, 'X', 'X6', 'BMW X6', 245, 335, 77900, '../img/x6.webp', 'The ultimate in luxury and space.', 'Petrol', '5.8s 0-100 km/h', '554');
...
INSERT INTO `checkout` (`checkout_id`, `user_id`, `order_id`, `payment_method`, `address`, `total_price`) VALUES
(1, 4, 12, 'Credit Card', 'asd', 120000.00),
(2, 4, 13, 'Credit Card', 'asd', 75500.00),
(5, 18, 16, 'Bank Transfer', 'cairo', 240000.00),
(6, 18, 17, 'Credit Card', 'asd', 56900.00),
(7, 4, 18, 'Credit Card', 'asd', 207000.00),
(8, 4, 19, 'Credit Card', 'blah blah', 87000.00),
(9, 4, 20, 'Credit Card', 'mm', 87000.00),
(10, 1, 21, 'Credit Card', 'qwe', 120000.00),
(11, 18, 22, 'Credit Card', 'asd', 87000.00);
...
(1, 12, 0, 327000.00, 'pending', 'PayPal', '2025-05-18 18:23:38', 'rqrq', 'complete'),
...
(7, 4, 0, 120000.00, 'complete', 'Credit Card', '2025-05-18 19:54:31', 'qrq', 'complete'),
(16, 18, 0, 240000.00, 'complete', 'Bank Transfer', '2025-05-24 20:57:38', 'cairo', 'pending'),
(17, 18, 0, 56900.00, 'pending', 'Credit Card', '2025-05-24 21:23:56', 'asd', 'complete'),
(18, 4, 0, 207000.00, 'pending', 'Credit Card', '2025-05-24 22:17:58', 'asd', 'complete'),
(19, 4, 0, 87000.00, 'pending', 'Credit Card', '2025-05-25 06:45:10', 'blah blah', 'pending'),
(22, 18, 0, 87000.00, 'pending', 'Credit Card', '2025-05-26 09:22:16', 'asd', 'complete');
...
CREATE TABLE `order_details` (
  `detail_id` int(100) UNSIGNED NOT NULL,
...
(18, 'yousefkhaled', 'yousefkhaled@gmail.com', '123', 12345677);
...
--
ALTER TABLE `car`
  MODIFY `car_id` int(100) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `checkout`
  MODIFY `checkout_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `order`
--
ALTER TABLE `order`
  MODIFY `order_id` int(100) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `order_details`
--
ALTER TABLE `order_details`
  MODIFY `detail_id` int(100) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
